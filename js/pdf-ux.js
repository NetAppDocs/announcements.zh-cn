$(document).ready(function () {
  try {
    ...
    let zipLevel = "";
    let baseUrlSection = "/zh-cn/announcements/pdfs/sidebar/";
    let baseUrlPages = "/zh-cn/announcements/pdfs/pages/";
    let zipFilename = "";
    let zipFileSize = 0;
    zipLevel = zipLevel !== ""?zipLevel:1;
    zipFilename = zipFilename !== ''?zipFilename:"announcements.zh-cn.zip";
